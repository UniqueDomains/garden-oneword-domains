# Available .GARDEN One-Word Domains (23,295)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-23%2C295%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **23,295 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 23,295 domains · **Median ask:** $38.13 · **High-demand under $2,500:** 11
...
| -------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | ---------------- |
| health.garden  | resell    | —         | —             | high           | medium | 6      | Sav.com LLC      |
| half.garden    | available | $39.98    | —             | high           | low    | 4      | namecheap        |
| correct.garden | available | $39.98    | —             | high           | low    | 7      | namecheap        |
...
| apt.garden     | premium   | $500      | —             | high           | low    | 3      | name.com         |
| clx.garden     | available | $1.98     | $43.98        | low            | low    | 3      | namecheap        |
| tea.garden     | resell    | —         | —             | medium         | medium | 3      | GoDaddy.com, LLC |
...
| bow.garden     | premium   | $500      | —             | high           | low    | 3      | name.com         |
...
| link.garden    | resell    | —         | —             | medium         | medium | 4      | Spaceship, Inc.  |
| due.garden     | premium   | $500      | —             | high           | low    | 3      | name.com         |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 23,295 live domains                        |
...
> Unique Domains. *Available .GARDEN One-Word Domains*. Version 2026-09-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
